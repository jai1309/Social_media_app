      ...
      <div className='w-full max-w-md'>
        <div className='text-center mb-4 flex items-center justify-between'>
            ...
            <div className='rounded-lg h-96 flex items-center justify-center relative' style={{backgroundColor: background}}>
                ...
                {mode === 'text' && (
                    <textarea className='bg-transparent text-white w-full h-full p-6 text-lg resize-none focus:outline-none' placeholder="Type Something...." onChange={(e)=>setText(e.target.value)} value={text}/>
                )}
                {
            ...
            <button onClick={()=> toast.promise(handleCreateStory(), {
                ...
                error : e => <p> Could not add story{e.message}</p>,
